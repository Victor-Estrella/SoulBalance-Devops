...
RESOURCE_GROUP_APP="rg-soulbalance"
RESOURCE_GROUP_DB="rg-soulbalance-db"
LOCATION="brazilsouth"
APP_SERVICE_PLAN="soulbalance-plan"
WEBAPP_NAME="app-pt-rm556206"
PLAN_SKU="F1"
RUNTIME="JAVA:17-java17"

SQL_SERVER_NAME="sql-server-soulbalance"
SQL_DB_NAME="db-soulbalance"
SQL_ADMIN_USER="user-soulbalance"
SQL_ADMIN_PASSWORD="SoulB@lance2024#"
